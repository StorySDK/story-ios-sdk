...
final class LazyImageLoader {
    ...
    func loadImage(url: URL?, completion: @escaping (_ image: UIImage?, _ error: LazyImageLoaderError?) -> Void) {
    ...
    func loadGifImage(url: URL?, size: CGSize, completion: @escaping (_ images: [UIImage]?, _ duration: TimeInterval, _ error: LazyImageLoaderError?) -> Void) {
